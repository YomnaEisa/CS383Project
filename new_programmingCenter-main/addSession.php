...
<div class="container">
    ...
    <div class="container-text">
      <h1 class="h-form" style="color:#fff;   font-size: 1.2rem;">Add a Session <br>According to your time!</h1>
      <p class="p-form" style="color:#fff">You can schedule your own session with the Programming Center Team, We Encourage students to get help <br>At any Time.</p>
         ...
         style = "width: 100%; border: none; padding: 14px; border-radius: 3px; margin-bottom: 2%; margin-top: 1%;">
