...
<?php
 ...
 <?php 
         ...
         $session = $user->appointments($_SESSION['user_name']);
  
         if ($session == null)
          echo "<h3>No appointment is added</h3>";
      ...
      <h3><?php echo $data['course'];?></h3>
      <p>Student Name: <?php echo $data['student_name'];?></p>
      <p>Student ID: <?php echo $data['student_id'];?></p>
      <p>date: <?php echo $data['date_time'];?></p>
      <p>details: <?php echo $data['details'];?></p>
</div>
  </div>
